...
export default function MatchDetail() {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-4 md:gap-8">
            <div className="flex flex-col items-center gap-2 flex-1 min-w-0">
              <FlagImage
                ...
                size={160}
                className="w-16 h-11 object-cover shadow-lg"
              />
      ...
      {/* Free Stats — for group-stage matches with scores (live or finished) */}
      {match.id.startsWith('Group-') && (isLive || isFinished) && (
        <div className="max-w-2xl mx-auto">
          <MatchStatsCard matchId={match.id} isLive={isLive} />
        </div>
      )}
              ...
              {totalPicks > 0 && (
                <div className="mb-4 app-panel-muted rounded-2xl p-3">
                  ...
                  <div className="flex items-center gap-1 text-[11px]">
                    <span className="text-[#60E6F6] font-medium w-7 text-right">{picksA}</span>
                  ...
                  {isFinished && hasScore && match.dealInfo && (
                    <>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-xs text-white/80">{match.dealInfo.result}</span>
                      </div>
                      {match.deal !== '0' && (
