  ...
  return (
    <div className="app-panel overflow-hidden rounded-none">
      <div className="border-b border-[#17307C]/45 bg-[#0B1543]/62 px-4 py-3">
        <h3 className="font-display text-sm tracking-[0.24em] text-[#9DEFF9]">GROUP {group}</h3>
      </div>
              ...
              >
                <td className="py-2 px-3">
                  ...
                  >
                    ...
                    />
                    <span className="text-white text-xs truncate max-w-[80px] sm:max-w-[100px]">
                      {row.team}
                    </span>
                  </Link>
                </td>
                <td className="text-center py-1.5 px-1 text-white/70 tabular-nums">{row.played}</td>
                <td className="text-center py-1.5 px-1 text-white/70 tabular-nums hidden sm:table-cell">
                  {row.won}
                </td>
                <td className="text-center py-1.5 px-1 text-white/70 tabular-nums hidden sm:table-cell">
                  {row.drawn}
                ...
                <td className="text-center py-1.5 px-1 text-white/70 tabular-nums hidden md:table-cell">
                  {row.gf}
                </td>
                <td className="text-center py-1.5 px-1 text-white/70 tabular-nums hidden md:table-cell">
                  {row.ga}
                ...
                <td className="text-center py-1.5 px-2 tabular-nums text-white font-bold">
                  {row.pts}
                </td>
              </tr>
            ))}
